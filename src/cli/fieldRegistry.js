...
fieldRegistry.register({
  ...
  fields: [
    ...
    { name: 'mode', description: 'Sketch mode (p5js, pjs [alias: processingjs], etc.)', type: 'string' },
...
fieldRegistry.register({
  ...
  fields: [
    ...
    { name: 'createdOn', description: 'Creation date', type: 'date' },
    { name: 'updatedOn', description: 'Last modification date', type: 'date' },
    { name: 'mode', description: 'Sketch mode (p5js, pjs [alias: processingjs], html, applet)', type: 'string' },
