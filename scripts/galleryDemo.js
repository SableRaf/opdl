#!/usr/bin/env node
// Dev harness for the gallery template: scaffolds a gallery with two basic
// full-viewport test sketches so the slideshow crossfade can be checked
// visually without downloading a real curation.
...
const DEMO_SKETCHES = [
  {
    ...
    html: `<!doctype html>
<html lang="en">
<head><meta charset="UTF-8"><title>Demo A</title>
...
`,
  },
  {
    ...
    html: `<!doctype html>
<html lang="en">
<head><meta charset="UTF-8"><title>Demo B</title>
